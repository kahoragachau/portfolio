...
| Scrum	 | Answers 	| 
|----------	|-------	|
| Doing today? | Setting up machine for the project|
| Objective | Install the required dependencies for the project i.e the right node version and the right angular version.  |
| Blockers? | No blockers |

<h2 align="center">05/02</h2>
...
| Scrum	 | Answers 	| 
|----------	|-------	|
| Doing today? | Learn angular |
| Objective | Build a basic angular web app && deploy it using firebase |
| Blockers? | No blockers |
