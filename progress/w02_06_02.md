...
| Scrum	       | Answers 	| 
|----------	   |-------	  |
| Doing today? | Continue Learning Angular    |
| Objective    |  Continue building project using angular to understand more about it.        |
| Blockers?    | Something about angular services.         |
...
|----------	   |-------	  |
| Doing today? | Continue Learning Angular    |
| Objective    |  Continue building tour of heroed project using angular to understand more about it.        |
| Blockers?    |  |
...
| Scrum	       | Answers 	| 
|----------	   |-------	  |
| Doing today? | Working On my first Issue    |
| Objective    | To add a component that displays elewa group partners       |
| Blockers?    | None|  
...
- [X] recieve feedback on my first issue
-  
