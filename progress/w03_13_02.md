...
| Scrum	       | Answers 	| 
|----------	   |-------	  |
| Doing today? |   Fix issue #38       |
| Objective    | Implement Feedback given     |
| Blockers?    |          |
...
| Date     	| Issue 	| Status 	| Link 	|
|----------	|-------	|--------	|------	|
| 14/02/23 	| 🎨 Create reusable partner orgs section | Merged | [#38](https://github.com/italanta/elewa-group/issues/38) |

<h2 align="center">15/02</h2>

| Scrum	       | Answers 	| 
|----------	   |-------	  |
| Doing today? | 🎨 Create Social Impact open knowledge section #34       |
| Objective    | Fix Issue #34    |
| Blockers?    |          |
...
|----------	   |-------	  |
| Doing today? | 🎨 Create Social Impact open knowledge section #34       |
| Objective    | Await feedback and review on issue [#34](https://github.com/italanta/elewa-group/issues/34)   |
| Blockers?    |          |
